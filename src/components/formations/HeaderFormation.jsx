        ...
        <div className="absolute top-0 px-20 py-16 w-full h-full flex justify-start items-center">
           <div className="flex items-center">
                <div className="relative w-full">                   
                    <h2 className='text-[60px] text-white/55 left-6 -top-4 font-semibold absolute'>Nos Formations</h2>
                    <h2 className='text-[120px] text-white font-semibold'>Nos Formations</h2>
