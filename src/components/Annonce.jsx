...
const Annonce = () => {
  ...
  return (
    <div className='w-full h-full pt-10 flex space-x-2 items-center justify-center'>
      ...
      <div className="flex items-center space-x-4 ">
          <div className="">
              <p className="text-happy text-base md:text-2xl lg:text-4xl font-semibold">Prochaine rentrée : </p>
          </div>
          <div className="">
            {date ? (
              <p className='text-base md:text-xl lg:text-3xl'>{formatDate(date.demarrage)}</p>
            ) : (
              <p className='text-base md:text-xl lg:text-3xl italic'>Aucune date pour l'instant</p>
            )}
          </div>
      </div>
      <div className="flex items-center space-x-1 md:space-x-2">
