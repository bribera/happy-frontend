...
const Agree = () => {
  return (
    <div className='py-1.5 text-[10px] md:text-base border border-b-2 border-amber-600 w-full flex flex-col md:flex-row justify-center  items-center'>
        ...
        <div className="flex space-x-1 items-center flex-col lg:flex-row">
